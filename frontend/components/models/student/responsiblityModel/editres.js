...
import { asynEditPositionOfResp } from "@/store/Actions/studentActions";
import { toast } from "react-toastify";


const EditPositionOfResp = ({id})=> {
  ...
  const formHandyy = (data) => {
    dispatch(asynEditPositionOfResp(data , id))
    toast.success("Position of responsibility updated successfully")
...
export default EditPositionOfResp;