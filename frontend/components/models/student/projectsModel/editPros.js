...
import { asynEditProjects } from "@/store/Actions/studentActions";
...
const EditProjects = ({ id }) => {
  ...
  const formHandyy = (data) => {
    dispatch(asynEditProjects(id , data));
  ...
  return (
    <>
      ...
      <Button className="bg-transparent " onPress={onOpen}>
        <BsFillPencilFill className="text-gray-400 hover:text-gray-500 text-2xl" />
      </Button>
